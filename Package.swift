...
let package = Package(
    ...
    products: [
        ...
        .library( name: "WavesUtil", targets: ["WavesUtil"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target( name: "WavesUtil", dependencies: ["Crpytoworks", "Keccak", "Curve25519", "Blake2", "Ed25519"]),
        ...
        .testTarget( name: "WavesUtilTests", dependencies: ["WavesUtil"]),
    ]
)
